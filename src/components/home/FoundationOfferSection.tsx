...
import type { FoundationOffer } from "@/lib/types";

export default function FoundationOfferSection({ offer }: { offer: FoundationOffer }) {
  return (
      ...
      <div className="mx-auto max-w-5xl px-5 lg:px-8">
        ...
        >
          <div className="rounded-[1.1rem] bg-bg-deepest p-8 lg:p-12">
            ...
            <div className="mt-10">
              <PrimaryLink href={offer.cta.href}>{offer.cta.label}</PrimaryLink>
            </div>
          </div>
        </motion.div>
      </div>
